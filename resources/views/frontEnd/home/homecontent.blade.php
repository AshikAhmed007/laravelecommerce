						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/admin/')}}/images/{{'pic-'.$product->id.'.'.$product->productImage}}" alt="" class="pro-image-front" height="250px" width="200px">
									<img src="{{asset('/admin/')}}/images/{{'pic-'.$product->id.'.'.$product->productImage}}" alt="" class="pro-image-back" height="250px" width="200px">
								...
								<div class="item-info-product ">
									<h4><a href="{{url('/product-details/'.$product->id)}}">{{$product->productName}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">TK {{$product->productPrice}}</span>
										<del>TK 69.71 </del>
									</div>
									<form action="/add-to-cart" method="POST">
									@csrf
									<input type="hidden" name="qty" value="1" min="1" class="form-control" />
